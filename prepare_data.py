"""
Tokenize a slice of FineWeb-Edu into train.bin / val.bin, same binary format
nanoGPT uses (uint16 memmap, since GPT-2's 50257 vocab fits in 16 bits).
...
def main():
    ...
    for doc in ds:
        ...
        # fill val first (small, cheap), then train
